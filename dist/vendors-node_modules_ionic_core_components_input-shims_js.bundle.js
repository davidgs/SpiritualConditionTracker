"use strict";
(self["webpackChunkspiritual_condition_tracker"] = self["webpackChunkspiritual_condition_tracker"] || []).push([["vendors-node_modules_ionic_core_components_input-shims_js"],{
...
const enableScrollAssist = (componentEl, inputEl, contentEl, footerEl, keyboardHeight, enableScrollPadding, keyboardResize, disableClonedInput = false) => {
     ...
     */
    const platformHeight = _index6_js__WEBPACK_IMPORTED_MODULE_2__.w !== undefined ? _index6_js__WEBPACK_IMPORTED_MODULE_2__.w.innerHeight : 0;
    /**
    ...
    const focusOut = () => {
        ...
        _index6_js__WEBPACK_IMPORTED_MODULE_2__.w === null || _index6_js__WEBPACK_IMPORTED_MODULE_2__.w === void 0 ? void 0 : _index6_js__WEBPACK_IMPORTED_MODULE_2__.w.removeEventListener('ionKeyboardDidShow', keyboardShow);
    ...
    const focusIn = async () => {
        ...
        _index6_js__WEBPACK_IMPORTED_MODULE_2__.w === null || _index6_js__WEBPACK_IMPORTED_MODULE_2__.w === void 0 ? void 0 : _index6_js__WEBPACK_IMPORTED_MODULE_2__.w.addEventListener('ionKeyboardDidShow', keyboardShow);
...
const startInputShims = async (config, platform) => {
     ...
     */
    if (_index6_js__WEBPACK_IMPORTED_MODULE_2__.d === undefined) {
        return;
    }
    ...
    const inputs = Array.from(_index6_js__WEBPACK_IMPORTED_MODULE_2__.d.querySelectorAll('ion-input, ion-textarea'));
    ...
    _index6_js__WEBPACK_IMPORTED_MODULE_2__.d.addEventListener('ionInputDidLoad', (ev) => {
        registerInput(ev.detail);
    });
    _index6_js__WEBPACK_IMPORTED_MODULE_2__.d.addEventListener('ionInputDidUnload', (ev) => {
